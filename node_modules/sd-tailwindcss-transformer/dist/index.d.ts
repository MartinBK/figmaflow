import { Config, Platform } from 'style-dictionary/types';
...
declare const makeSdTailwindConfig: ({ type, formatType, isVariables, source, transforms, buildPath, tailwind }: SdTailwindConfigType) => Config;

export { makeSdTailwindConfig };
